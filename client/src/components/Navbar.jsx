  ...
  return (
    <header className="bg-gray-50">
      <div className="w-full max-w-screen-2xl mx-auto flex justify-between items-center px-3 xl:px-5 py-3 bg-gray-50">
        <Link to={"/"}>
          <div className="hidden md:flex items-center text-4xl font-extrabold text-gray-900 cursor-pointer">
        ...
        <div className="flex md:hidden items-center space-x-4 mx-auto">
          ...
          <div className="profile-container relative">
            <div
              className="profile-placeholder cursor-pointer"
      ...
      <nav className="bg-gray-800 bg-opacity-80 px-5">
        <div className="md:hidden h-14 flex items-center justify-between">
          <Link to="/">
            <div className=" md:hidden items-center text-3xl font-extrabold text-gray-900">
              <span className="text-yellow-500">VIVA</span>
              <span className="text-black ml-1">BAGS</span>
            </div>
          </Link>
          ...
          <button
            onClick={toggleMenu}
            className="text-yellow-500 ml-4 md:hidden"
          >
            <FaBars size={24} />
          </button>
        </div>
        ...
        <div className="hidden h-16 md:flex items-center justify-between">
          <div className="hidden md:block relative">
            ...
            >
              ...
              {searchCategory
                ? categories.find((cat) => cat._id === searchCategory)?.name
                : "All Categories"}
              <svg
            ...
            {isOpen && (
              <div
                onClick={toggleDropdown}
                className="absolute left-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg overflow-hidden z-10"
              >
                <div
                  onClick={() => {
                    setSearchCategory("");
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <Link to="/shop" className="text-white hover:text-yellow-500">
              Shop
            </Link>

...
const Header = () => {
  const { adminLogout, admin } = useContext(AuthContext);
  ...
  return (
    <header className="bg-gradient-to-r min-h-[12vh] from-gray-900 to-indigo-800 shadow-xl p-4 flex justify-between items-center">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          <div
            ...
            className="w-10 h-10 rounded-full flex items-center justify-center text-2xl text-white bg-yellow-400 hover:ring-4 hover:ring-yellow-400 transition-all duration-300"
          >{admin.username.split('')[0].toUpperCase()}</div>
          {/* Status indicator */}
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-6 mt-28 w-48 bg-white shadow-lg rounded-lg z-10">
          <ul className="py-2">
            {/* <li>
